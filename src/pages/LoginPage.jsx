      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: 40 }}>
            {[
              ["Prise de RDV en ligne", "Réservez en quelques clics"],
              ["Synchronisation en temps réel", "Patient, Médecin et Secrétaire liés"],
              ["Messagerie intégrée", "Secrétaire contacte les patients directement"],
            ].map(([t, s]) => (
              <div
                key={t}
                style={{
            ...
            {["patient", "medecin", "secretaire"].map((r) => (
              <button
                ...
                style={{
                  ...
                  padding: "9px 5px",
                  borderRadius: 9,
                  border: `1.5px solid ${role === r ? C.tealDk : C.border}`,
                  background: role === r ? C.tealLt : C.white,
                  color: role === r ? C.tealDk : C.gray500,
                  fontWeight: 700,
                  fontSize: 12,
                  cursor: "pointer",
                  fontFamily: "inherit",
