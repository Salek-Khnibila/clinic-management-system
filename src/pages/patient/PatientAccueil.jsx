...
export const PatientAccueil = ({ user }) => {
  const { rdvs, addRdv, messages, doctors, patients, refreshData } = useApp();
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={headerStyle}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6, opacity: 0.8, marginBottom: 18 }}>
            ...
            <span style={{ fontSize: isMobile ? 12 : 13 }}>Espace Patient</span>
            <Btn
              variant="ghost"
              size="sm"
              icon={RefreshCw}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span
                      style={{ fontSize: isMobile ? 8 : 9, color: C.gray400 }}
                    >
                      {
                        MONTHS[
      ...
      <SectionTitle
        sub={`${filtered.length} médecin${filtered.length !== 1 ? "s" : ""
